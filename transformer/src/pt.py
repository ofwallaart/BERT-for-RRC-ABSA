...
BASELINE_CLASSES = {
    'Bert': (TextDataset, TextDataset, Trainer, BertMasker, BertMasker, "Bert"),
    'SkipDomBert': (XDDataset, XDDataset, Trainer, SkipDomBertMasker, SkipDomBertMasker, "SkipDomBert"),
}
